...
Во второй итерации можно переходить к автоматизации ручного тестирования (вместо разделения AQA и ручного тестирования). Только вместо GraphQL, взаимодействуем с UI приложений. Всё! Мы получили приёмочные UI-тесты для проверки бизнес-логики.
...
- [k6 + Gherkin: Нагрузочные тесты API](https://gemini.google.com/share/9fb1263722bb)
